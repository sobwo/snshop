...
<html>
<head>
	<link href="${pageContext.request.contextPath}/resources/css/myPage/purchase_popup.css" rel="stylesheet"/>
</head>
<body>
	<!-- 팝업창 -->
	<div class="search_filter_popup_wrap ing_popup" style="display:none">
		<div class="search_filter_popup">
			...
			<div class="popup_contents">
				<ul class="status_item_list">
					<li class="status_item"><span>전체</span></li>
	...
	<div class="search_filter_popup_wrap end_popup" style="display:none">
		<div class="search_filter_popup">
			<div class="popup_head">
				<h2 class="popup_name">선택한 상태 보기</h2>
				<div class="popup_cancel">X</div>
			...
			<div class="popup_contents">
				<ul class="status_item_list">
					...
					<li class="status_item"><span>취소완료</span></li>
