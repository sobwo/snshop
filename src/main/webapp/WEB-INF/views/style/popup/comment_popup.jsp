			...
			<div class="comment_top">
           	<c:choose>
        		<c:when test="${empty mv.profileImg}">
       				<img class="user_img user_profileImg" src="${pageContext.request.contextPath}/resources/image/blank_profile.png" alt="빈 프로필 사진">
        		</c:when>
        		<c:otherwise>
					<img class="user_img user_profileImg" src="${pageContext.request.contextPath}/myPage/displayFile.do?contentsImg=${mv.profileImg}&index=style">
        		</c:otherwise>
       		</c:choose>
